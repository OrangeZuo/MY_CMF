...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/MY_CMF/Public/Admin/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/MY_CMF/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>ZF内容管理平台</h3>
	...
	<!--[if lt IE 9]>
    <script type="text/javascript" src="/MY_CMF/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/MY_CMF/Public/static/jquery-2.0.3.min.js"></script>
    <!--<![endif]-->
