...
<body>
		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							是否单页面<span class="check-tips">（是否为单文章）</span>
						</label>
						<div class="controls">
							<label class="inline radio"><input type="radio" name="is_page" value="1">是</label>
							<label class="inline radio"><input type="radio" name="is_page" value="0" checked>不是</label>
						</div>
					</div>
					<div class="form-item">
	...
	<script type="text/javascript">
        ...
        Think.setValue("is_page", <?php echo ((isset($info["is_page"]) && ($info["is_page"] !== ""))?($info["is_page"]):0); ?>);
