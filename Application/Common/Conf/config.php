...
return array(
    ...
    'URL_ROUTE_RULES'=>array(
        ...
        '/^xiaosongqiangxiangweixiu\/p\/(\d+)$/'            => 'article/lists?brand=23&category=82&p=:1',
        ...
        '/^xiaosongguzhangweixiu\/p\/(\d+)$/'            => 'article/lists?brand=23&category=83&p=:1',
        ...
        '/^xiaosongchanpinzhanshi\/p\/(\d+)$/'            => 'article/lists?brand=23&category=70&p=:1',
        ...
        '/^shengangguzhangweixiu\/p\/(\d+)$/'            => 'article/lists?brand=36&category=87&p=:1',
        ...
        '/^shengangchanpinzhanshi\/p\/(\d+)$/'            => 'article/lists?brand=36&category=73&p=:1',
        ...
        '/^libohaierguzhangweixiu\/p\/(\d+)$/'            => 'article/lists?brand=91&category=107&p=:1',
        ...
        '/^libohaierchanpinzhanshi\/p\/(\d+)$/'            => 'article/lists?brand=91&category=113&p=:1',
        ...
        '/^woerwoguzhangweixiu\/p\/(\d+)$/'    => 'article/lists?brand=90&category=102&p=:1',
        '/^woerwoguzhangweixiu\/(\d+)$/' => 'article/detail?brand=90&category=102&id=:1',
        '/^woerwochanpinzhanshi$/'   => 'article/lists?brand=90&category=106',
        '/^woerwochanpinzhanshi\/p\/(\d+)$/'   => 'article/lists?brand=90&category=106&p=:1',
        '/^woerwochanpinzhanshi\/(\d+)$/' => 'article/detail?brand=90&category=106&id=:1',
        '/^woerwochenggonganli$/'    => 'article/lists?brand=90&category=105',
        '/^woerwochenggonganli\/p\/(\d+)$/'            => 'article/lists?brand=90&category=105&p=:1',
        '/^woerwochenggonganli\/(\d+)$/' => 'article/detail?brand=90&category=105&id=:1',
        '/^woerwozixun$/'            => 'article/lists?brand=90&category=104',
        '/^woerwozixun\/p\/(\d+)$/'            => 'article/lists?brand=90&category=104&p=:1',
        '/^woerwozixun\/(\d+)$/' => 'article/detail?brand=90&category=104&id=:1',


        '/^weixiuzixun$/'       =>  'article/lists?class=weixiuzixun',
        '/^weixiuzixun\/p\/(\d+)$/'  =>  'article/lists?class=weixiuzixun&p=:1',
        '/^weixiuzixun\/(\d+)$/' => 'article/detail?id=:1',

        '/^zixun$/'       =>  'article/lists?class=zixun',
        '/^zixun\/p\/(\d+)$/'       =>  'article/lists?class=zixun&p=:1',
        '/^zixun\/(\d+)$/' => 'article/detail?class=zixun&id=:1',

        '/^anli$/'       =>  'article/lists?class=anli',
        '/^anli\/p\/(\d+)$/'       =>  'article/lists?class=anli&p=:1',
        '/^anli\/(\d+)$/' => 'article/detail?class=anli&id=:1',

        '/^changjianwenti$/'       =>  'article/lists?class=changjianwenti',
        '/^changjianwenti\/p\/(\d+)$/'       =>  'article/lists?class=changjianwenti&p=:1',
        '/^changjianwenti\/(\d+)$/'       =>  'article/detail?class=changjianwenti&id=:1',

        '/^chanpinzhanshi$/'       =>  'article/lists?class=chanpin',
        '/^chanpinzhanshi\/p\/(\d+)$/'       =>  'article/lists?class=chanpin&p=:1',
        '/^chanpinzhanshi\/(\d+)$/'       =>  'article/detail?class=chanpin&id=:1',

        '/^guanyuwomen$/'       =>  'article/detail?id=61',
        '/^sousuo\/(.*)$/'       =>  'article/lists?keywords=:1',


        '/^weixiuliucheng$/'       =>  'article/detail?id=150',
        '/^weixiufanwei$/'       =>  'article/detail?id=151',
        '/^lianxiwomen$/'       =>  'article/detail?id=152',
