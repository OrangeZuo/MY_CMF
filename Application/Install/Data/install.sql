...
--
-- Host: localhost
-- Generation Time: 2017-03-27 14:08:49
-- 服务器版本： 5.7.17
-- PHP Version: 7.1.2
...
DROP TABLE IF EXISTS `exp_action`;
...
INSERT INTO `exp_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
DROP TABLE IF EXISTS `exp_action_log`;
CREATE TABLE `exp_action_log` (
...
DROP TABLE IF EXISTS `exp_addons`;
CREATE TABLE `exp_addons` (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键',
...
INSERT INTO `exp_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
--
-- 表的结构 `exp_advertise_data`
--

DROP TABLE IF EXISTS `exp_advertise_data`;
CREATE TABLE `exp_advertise_data` (
  `id` int(10) UNSIGNED NOT NULL COMMENT '广告信息编号',
...
--
-- 表的结构 `exp_advertise_position`
--

DROP TABLE IF EXISTS `exp_advertise_position`;
CREATE TABLE `exp_advertise_position` (
  `id` smallint(5) UNSIGNED NOT NULL COMMENT '广告位编号',
  ...
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间',
  `status` tinyint(3) NOT NULL DEFAULT '1' COMMENT '广告位状态 1:启用 0:禁用 -1:删除'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='广告模块-广告位表';
...
DROP TABLE IF EXISTS `exp_attribute`;
CREATE TABLE `exp_attribute` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- 转存表中的数据 `exp_attribute`
--

INSERT INTO `exp_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
--
-- 表的结构 `exp_auth_extend`
--

DROP TABLE IF EXISTS `exp_auth_extend`;
CREATE TABLE `exp_auth_extend` (
...
--
-- 转存表中的数据 `exp_auth_extend`
--

INSERT INTO `exp_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
DROP TABLE IF EXISTS `exp_auth_group`;
CREATE TABLE `exp_auth_group` (
...
--
-- 转存表中的数据 `exp_auth_group`
--

INSERT INTO `exp_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
--
-- 表的结构 `exp_auth_group_access`
--

DROP TABLE IF EXISTS `exp_auth_group_access`;
CREATE TABLE `exp_auth_group_access` (
...
DROP TABLE IF EXISTS `exp_auth_rule`;
CREATE TABLE `exp_auth_rule` (
...
--
-- 转存表中的数据 `exp_auth_rule`
--

INSERT INTO `exp_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
INSERT INTO `exp_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `is_page`, `status`, `icon`) VALUES
(1, 'blog', '博客', 0, 1, 10, '', '', '', '', '', '', '', '2', '2,1', 0, 0, 1, 0, 0, '1', '', 1379474947, 1490373119, 0, 1, 0),
(2, 'default_blog', '默认分类', 1, 2, 10, '', '', '', '', '', '', '', '2', '2,1,3', 0, 1, 1, 0, 1, '1', '', 1379475028, 1490372020, 0, 1, 31),
...
DROP TABLE IF EXISTS `exp_channel`;
CREATE TABLE `exp_channel` (
...
INSERT INTO `exp_channel` (`id`, `pid`, `name`, `group`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`, `master`) VALUES
(1, 0, '', '', '首页', 'Index/index', 1, 1379475111, 1490363921, 1, 1, 1),
(2, 0, '', '', '博客', 'Article/index?category=blog', 2, 1379475131, 1379483713, 1, 0, 0),
(3, 0, '', '', '官网', 'http://www.onethink.cn', 3, 1379475154, 1490366297, 1, 0, 0);
...
INSERT INTO `exp_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
DROP TABLE IF EXISTS `exp_document`;
...
--
-- 转存表中的数据 `exp_document`
--

INSERT INTO `exp_document` (`id`, `uid`, `name`, `title`, `category_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
(1, 1, '', 'OneThink1.0正式版发布', 2, '大家期待的OneThink正式版发布', 0, 0, 2, 2, 0, 0, 2, 1, 0, 0, 9, 0, 0, 0, 1387260660, 1490619515, 1);

-- --------------------------------------------------------

--
-- 表的结构 `exp_document_article`
--

DROP TABLE IF EXISTS `exp_document_article`;
CREATE TABLE `exp_document_article` (
...
--
-- 转存表中的数据 `exp_document_article`
--

INSERT INTO `exp_document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
...
--
-- 表的结构 `exp_document_download`
--

DROP TABLE IF EXISTS `exp_document_download`;
CREATE TABLE `exp_document_download` (
  `id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
DROP TABLE IF EXISTS `exp_hooks`;
CREATE TABLE `exp_hooks` (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键',
...
INSERT INTO `exp_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`) VALUES
...
DROP TABLE IF EXISTS `exp_member`;
CREATE TABLE `exp_member` (
  `uid` int(10) UNSIGNED NOT NULL COMMENT '用户ID',
...
INSERT INTO `exp_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`) VALUES
...
DROP TABLE IF EXISTS `exp_model`;
...
INSERT INTO `exp_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
DROP TABLE IF EXISTS `exp_page`;
CREATE TABLE `exp_page` (
...
INSERT INTO `exp_page` (`catid`, `title`, `keywords`, `description`, `content`, `template`, `updatetime`, `thumb`) VALUES
...
DROP TABLE IF EXISTS `exp_picture`;
CREATE TABLE `exp_picture` (
...
--
-- 表的结构 `exp_ucenter_admin`
--

DROP TABLE IF EXISTS `exp_ucenter_admin`;
CREATE TABLE `exp_ucenter_admin` (
...
--
-- 表的结构 `exp_ucenter_app`
--

DROP TABLE IF EXISTS `exp_ucenter_app`;
CREATE TABLE `exp_ucenter_app` (
...
--
-- 表的结构 `exp_ucenter_member`
--

DROP TABLE IF EXISTS `exp_ucenter_member`;
CREATE TABLE `exp_ucenter_member` (
...
--
-- 表的结构 `exp_ucenter_setting`
--

DROP TABLE IF EXISTS `exp_ucenter_setting`;
CREATE TABLE `exp_ucenter_setting` (
...
DROP TABLE IF EXISTS `exp_userdata`;
CREATE TABLE `exp_userdata` (
  `uid` int(10) UNSIGNED NOT NULL COMMENT '用户id',
...
--
-- Indexes for table `exp_action`
--
ALTER TABLE `exp_action`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_action_log`
--
ALTER TABLE `exp_action_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `exp_addons`
--
ALTER TABLE `exp_addons`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_advertise_data`
--
ALTER TABLE `exp_advertise_data`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_advertise_position`
--
ALTER TABLE `exp_advertise_position`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `only_sign_status` (`only_sign`,`status`);

--
-- Indexes for table `exp_attachment`
--
...
--
-- Indexes for table `exp_attribute`
--
ALTER TABLE `exp_attribute`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_id` (`model_id`);

--
-- Indexes for table `exp_auth_extend`
--
ALTER TABLE `exp_auth_extend`
  ADD UNIQUE KEY `group_extend_type` (`group_id`,`extend_id`,`type`),
  ADD KEY `uid` (`group_id`),
  ADD KEY `group_id` (`extend_id`);

--
-- Indexes for table `exp_auth_group`
--
ALTER TABLE `exp_auth_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_auth_group_access`
--
ALTER TABLE `exp_auth_group_access`
  ADD UNIQUE KEY `uid_group_id` (`uid`,`group_id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `group_id` (`group_id`);

--
-- Indexes for table `exp_auth_rule`
--
ALTER TABLE `exp_auth_rule`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `exp_channel`
--
ALTER TABLE `exp_channel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`);
...
--
-- Indexes for table `exp_document`
--
...
--
-- Indexes for table `exp_document_article`
--
ALTER TABLE `exp_document_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_document_download`
--
ALTER TABLE `exp_document_download`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_file`
--
ALTER TABLE `exp_file`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_md5` (`md5`);

--
-- Indexes for table `exp_hooks`
--
ALTER TABLE `exp_hooks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Indexes for table `exp_member`
--
ALTER TABLE `exp_member`
  ADD PRIMARY KEY (`uid`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `exp_menu`
--
ALTER TABLE `exp_menu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`);

--
-- Indexes for table `exp_model`
--
ALTER TABLE `exp_model`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_page`
--
ALTER TABLE `exp_page`
  ADD PRIMARY KEY (`catid`);

--
-- Indexes for table `exp_picture`
--
ALTER TABLE `exp_picture`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_ucenter_admin`
--
ALTER TABLE `exp_ucenter_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_ucenter_app`
--
ALTER TABLE `exp_ucenter_app`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `exp_ucenter_member`
--
ALTER TABLE `exp_ucenter_member`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `exp_ucenter_setting`
--
ALTER TABLE `exp_ucenter_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `exp_url`
--
ALTER TABLE `exp_url`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `exp_userdata`
--
ALTER TABLE `exp_userdata`
